jQuery(document).ready(function($) {
    ...
    function CMB2ConditionalsInit(changeContext, conditionContext) {
        ...
        changeContext.on("change", "input, textarea, select", function(evt) {
            var elm = $(this), fieldName = $(this).attr("name"), dependants, dependantsSeen = [], checkedValues, elmValue;
            ...
            if (dependants.length > 0) {
                ...
                dependants.each(function(i, e) {
                    var loopIndex = 0, current = $(e), currentFieldName = current.attr("name"), requiredValue = current.data("conditional-value"), currentParent = current.parents(".cmb-row:first"), shouldShow = false;
        ...
        $(".cmb2-wrap > .cmb2-metabox").on("cmb2_add_row", function(evt, row) {
            var rowFormElms, rowRequiredElms = $("[data-conditional-id][required]", row);
    ...
    function CMB2ConditionalsRecursivelyHideDependants(fieldName, elm, context) {
        ...
        if (dependants.length > 0) {
            dependants.each(function(i, e) {
                var dependant = $(e), dependantName = dependant.attr("name");
    ...
    CMB2ConditionalsInit(".cmb2-wrap", ".cmb2-wrap");
});